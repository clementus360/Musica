	...
	<section className="fixed flex gap-56 bg-primary sm:gap-4 w-full justify-around sm:justify-between top-0 sm:pl-32 sm:pr-24 pt-7 pb-6 2xl:pl-44 2xl:pt-9 items-center z-30">
		<div className="flex">
			...
			<div className="gap-4 hidden sm:flex">
				<SearchIcon/>
				<input type="search" name="search" placeholder="Search artists" id="site-search" className="w-64 bg-primary text-lightGrey pl-4 outline-none focus:border-b-2 active:border-b-2 border-b-1 transition-all font-light text-sm 2xl:text-xl 4xl:text-3xl"/>
			</div>
		</div>
	</section>
  )
