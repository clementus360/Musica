  ...
  return (
	<div className="grid py-56 place-items-center min-h-screen h-max">
		...
		<section className="flex flex-col gap-4 items-center">
			<div className='flex items-center justify-center aspect-square h-56 max-h-56'><img className="max-h-full max-w-full object-cover aspect-square rounded-full" src={auth.user.image} alt={auth.user.username} /></div>
